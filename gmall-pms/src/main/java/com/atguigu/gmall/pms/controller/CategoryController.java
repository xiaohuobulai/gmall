...
public class CategoryController {
    ...
    public ResponseVo<List<CategoryEntity>> queryCategories(@PathVariable Long parentId) {
        List<CategoryEntity> categoryEntityList = this.categoryService.queryCategories(parentId);
    ...
    public ResponseVo<List<CategoryEntity>> queryLevel2CatesWithSubsPid(@PathVariable Long pid) {
        List<CategoryEntity> categoryEntities = this.categoryService.queryLevel2CatesWithSubsPid(pid);
