...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuInfo(PageParamVo pageParamVo, @PathVariable Long cid) {
        PageResultVo pageResultVo = this.spuService.querySpuInfo(pageParamVo, cid);
        return ResponseVo.ok(pageResultVo);
    }
