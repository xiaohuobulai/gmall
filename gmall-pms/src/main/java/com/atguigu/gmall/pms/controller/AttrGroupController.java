...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryAttrByLevel3Id(@PathVariable Long cid){
    ...
    public ResponseVo<List<GroupVo>> queryAttrsByCid(@PathVariable Long catId){
        List<GroupVo> groupVos = this.attrGroupService.queryAttrsByCid(catId);
